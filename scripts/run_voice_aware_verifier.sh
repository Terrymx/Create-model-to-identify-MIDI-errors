...
three_checkpoint="checkpoints/transformer_keyboard_aware_step2.pt"
binary_checkpoint="checkpoints/transformer_keyboard_aware_binary_unified_deleteaux_validation_step2.pt"
