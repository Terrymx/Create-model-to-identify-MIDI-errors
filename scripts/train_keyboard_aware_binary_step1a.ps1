...
& $Python -B -u -m midi_error_detector.train `
    ...
    --lr-threshold 0.001 `
    --num-workers 0 `
    --output "checkpoints\transformer_keyboard_aware_binary_step1a.pt" `
    1> "training_logs\keyboard_aware_binary_step1a.log" `
    2> "training_logs\keyboard_aware_binary_step1a.err.log"

if ($LASTEXITCODE -ne 0) {
    throw "Keyboard-aware binary Step 1A training failed with exit code $LASTEXITCODE"
}
